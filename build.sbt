...
libraryDependencies ++= Seq(
  ...
  "org.apache.curator" % "curator-framework" % "2.12.0" exclude("log4j","log4j") exclude("org.slf4j", "slf4j-log4j12") exclude ("org.apache.zookeeper", "zookeeper") force(),
  ...
  "org.apache.kafka" %% "kafka" % "2.4.0" exclude("log4j","log4j") exclude("org.slf4j", "slf4j-log4j12") exclude ("org.apache.zookeeper", "zookeeper") force(),
